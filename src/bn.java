...
public final class bn extends Form implements CommandListener {
   ...
   public bn() {
      ...
      this.append(this.aca = new TextField("ID map PK - (map hiện tại: " + TileMap.mapID + ")", Code.bwa != -1 ? String.valueOf(Code.bwa) : "70", 3, 2));
      this.append(this.ada = new TextField("Vị trí X - (vt hiện tại: " + Char.getMyChar().cx + ")", Code.bxa != -1 ? String.valueOf(Code.bxa) : "1500", 9, 2));
      this.append(this.aea = new TextField("Vị trí Y - (vt hiện tại: " + Char.getMyChar().cy + ")", Code.bya != -1 ? String.valueOf(Code.bya) : "528", 9, 2));
