...
public final class ge implements CommandListener {
   ...
   private final Form aoa = new Form("Cài đặt NVDV <Linh SuSu>");
   ...
   public ge() {
      this.baa = new TextField("Giờ điểm danh !", "" + Code.cba, 2, 2);
      this.bba = new TextField("Phút điểm danh !", "" + Code.cca, 2, 2);
   }
   ...
   private static void aaa(Displayable var0) {
      Display.getDisplay(Class_ab.aja).setCurrent(var0);
   }
   ...
   public final void commandAction(Command var1, Displayable var2) {
      if (var1 == this.apa) {
         try {
            ...
            Code.cba = Integer.parseInt(this.baa.getString());
            Code.cca = Integer.parseInt(this.bba.getString());
            ...
            try {
               ...
               ama.writeByte(aha);
               ama.writeByte(aia);
               ama.writeInt(Code.cba);
               ama.writeInt(Code.cca);
               ama.flush();
               ama.close();
               ala.flush();
   ...
   public static void aba() {
      ...
      try {
         if ((ana = RecordStore.openRecordStore("formdv", true)).getNumRecords() != 0) {
            ...
            afa = aka.readByte();
            aia = aka.readByte();
            Code.cba = aka.readInt();
            Code.cca = aka.readInt();
         }
