...
public final class gb {
   ...
   public static void aba() {
      ...
      if (!(Code.aba instanceof ds) && ((Char)var0).aua > 9 && aaa()) {
         ...
         for(short var2 = 0; var2 < 4; ++var2) {
            ...
            int var3;
            for(var3 = 0; var3 < ((Char)var0).arrItemBag.length; ++var3) {
               gg var4;
               if ((var4 = ((Char)var0).arrItemBag[var3]) != null && var4.aaa.aaa == var2) {
            ...
            while(((Vector)var1).size() >= 4) {
               ...
               int var6;
               for(var6 = var2; var6 < 4 && GameScr.dya[var6] <= ((Char)var0).csa && var3 << 2 <= ((Vector)var1).size() && var3 < 16; ++var6) {
                  var3 <<= 2;
               }
               ...
               for(var6 = 0; var6 < var3; ++var6) {
                  ...
                  ((Char)var0).arrItemBag[((gg)var5).ada] = null;
               ...
               if (GameScr.cwa[0] != null) {
                  ((Char)var0).arrItemBag[GameScr.cwa[0].ada] = GameScr.cwa[0];
               }
            }
         }
      }
