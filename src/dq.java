public final class dq extends fq {
   ...
   public final void aaa(String var1, ca var2, ca var3, ca var4) {
      this.afa = fw.aqa.aba(var1, ab.aza - ((this.aha << 1) + 40));
      super.aca = var2;
      super.ada = var3;
      super.aea = var4;
      if (var3 != null) {
         ...
         if (var2 != null) {
            super.aca.afa = ab.aza / 2 - 115;
            super.aca.aga = ab.baa - 26;
         }

         if (var4 != null) {
            super.aea.afa = ab.aza / 2 + 45;
            super.aea.aga = ab.baa - 26;
         }
      } else {
         if (var2 != null) {
            super.aca.afa = ab.aza / 2 - 80;
            super.aca.aga = ab.baa - 26;
         }

         if (var4 != null) {
            super.aea.afa = ab.aza / 2 + 10;
            super.aea.aga = ab.baa - 26;
         }
      }
   ...
   public final void aaa(as var1) {
      int var2 = ab.baa - this.aga - 38;
      fk.aaa(this.aha, var2, ab.aza - (this.aha << 1), this.aga, var1);
      var2 = var2 + (this.aga - this.afa.length * fw.aqa.aaa) / 2 - 2;
      if (this.aaa) {
         var2 += 8;
         ab.aaa(ab.bba, var2 - 12, var1);
      }

      for(int var3 = 0; var3 < this.afa.length; var2 += fw.aqa.aaa) {
         fw.aqa.aaa(var1, this.afa[var3], ab.bba, var2, 2);
         ++var3;
      }
